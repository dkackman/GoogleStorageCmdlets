...
#export-googlestoragebucket uspto-pair c:\storage -noauth -includemetadata -verbose -force

export-googlestoragebucket unit_tests c:\storage -includemetadata -verbose -force
